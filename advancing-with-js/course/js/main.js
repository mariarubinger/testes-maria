...
function formatDesc(desc){
    ...
    str = str.charAt(0).toUpperCase() + str.slice(1) /* coloca a primeira letra maiúscula */
    return str;
}

/* formatando a quantidade Amount - para não poder colocar letras invés de núemros */
...
function formatValue(value){
    ...
    str = str.replace(".",","); /* Substituir o ponto em vírgula */
    str = "$ " + str;
    return str;    
}
...
function deleteData(id){
    if(confirm("Delete this item?")){
        if(id === list.length - 1){   /* pra apagar o último item da lista */
            list.pop();
        }else if(id === 0){  /* pra apagar o primeiro item da lista */
            list.shift();
        }else{
